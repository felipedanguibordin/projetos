...
function exibirCartaJogador() {
  ...
  tagHTML +=
    "<div class='att-esquerda'><input type='radio' id='rd-ataqueJogador' name='atributo' onclick='atributoSelecionado(1)' value='ataque'> Ataque</div>";
  tagHTML +=
    "<div class='att-direita'>" + cartaJogador.atributos.ataque + "</div>";
  tagHTML += "</div>";
  tagHTML += "<div class='atributo-defesa'>";
  tagHTML +=
    "<div class='att-esquerda'><input type='radio' id='rd-defesaJogador' name='atributo' onclick='atributoSelecionado(2)' value='defesa'> Defesa</div>";
  tagHTML +=
    "<div class='att-direita'>" + cartaJogador.atributos.defesa + "</div>";
  tagHTML += "</div>";
  tagHTML += "<div class='atributo-forca'>";
  tagHTML +=
    "<div class='att-esquerda'><input type='radio' id='rd-forcaJogador' name='atributo' onclick='atributoSelecionado(3)' value='forca'> Força</div>";
  tagHTML +=
    "<div class='att-direita'>" + cartaJogador.atributos.forca + "</div>";
  tagHTML += "</div>";
  tagHTML += "</div>";
...
function exibirCartaMaquina() {
  ...
  tagHTML +=
    "<div class='att-direita'>" + cartaMaquina.atributos.ataque + "</div>";
  tagHTML += "</div>";
  tagHTML += "<div class='atributo-defesa'>";
  tagHTML += "<div class='att-esquerda'> Defesa</div>";
  tagHTML +=
    "<div class='att-direita'>" + cartaMaquina.atributos.defesa + "</div>";
  tagHTML += "</div>";
  tagHTML += "<div class='atributo-forca'>";
  tagHTML += "<div class='att-esquerda'> Força</div>";
  tagHTML +=
    "<div class='att-direita'>" + cartaMaquina.atributos.forca + "</div>";
  tagHTML += "</div>";
  tagHTML += "</div>";
